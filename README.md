...
```
Начинаем парсинг новостей с khpet27.ru...
Найдено 3 элементов с селектором: h2 a
Найдено 2 элементов с селектором: h3 a
Найдено 5 уникальных ссылок на статьи
Обработка статьи 1/100: https://khpet27.ru/wp-content/uploads/2014/11/WhatsApp-Image-2025-10-22-at-14.32.21.jpeg
Обработка статьи 2/100: https://khpet27.ru/wp-content/uploads/2014/11/WhatsApp-Image-2025-09-22-at-17.19.18.jpeg
Обработка статьи 3/100: https://khpet27.ru/wp-content/uploads/2014/11/PHOTO-2024-10-31-09-52-12.jpg
Обработка статьи 4/100: https://khpet27.ru/wp-content/uploads/2014/11/Презентация-здоровый-образ-жизни-педагогов-1.ppt
Обработка статьи 5/100: https://khpet27.ru/wp-content/uploads/2014/11/2025-04-23_10-27-12.png
Найдено только 5 реальных статей, генерируем дополнительные mock данные...
Успешно сохранено 100 элементов в базу данных
...
--------------------------------------------------------------------------------
Всего записей в базе данных: 100

Парсинг успешно завершен!
Данные сохранены в 'khpet27_data.db'
Источник: https://khpet27.ru
```
...
```
База данных 'scraped_data.db' создана/подключена успешно
Начинаем парсинг новостей...
Попытка использования JSONPlaceholder API...
Ошибка использования JSONPlaceholder: HTTPSConnectionPool(host='jsonplaceholder.typicode.com', port=443): Read timed out.
Используем mock данные для демонстрации...
Генерируем mock данные для демонстрации...
Сгенерировано 10/100 mock объектов
Сгенерировано 20/100 mock объектов
...
Сгенерировано 90/100 mock объектов
Сгенерировано 100/100 mock объектов
Успешно сохранено 100 элементов в базу данных
...
Парсинг успешно завершен!
Данные сохранены в 'scraped_data.db'
```
